...
pacman -S --noconfirm mingw-w64-x86_64-openexr mingw-w64-x86_64-libwebp mingw-w64-x86_64-graphicsmagick
pacman -S --noconfirm mingw-w64-x86_64-osm-gps-map mingw-w64-x86_64-pugixml mingw-w64-x86_64-libsoup
...
# pacman -S --noconfirm automake autoconf m4
