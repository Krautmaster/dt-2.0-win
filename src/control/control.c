...
#ifdef __WIN32__
  dt_conf_set_bool("ui_last/maximized", gtk_window_is_maximized(GTK_WINDOW(widget)));
#else
...
void *dt_control_expose(void *voidptr)
{
  ...
  gdk_window_get_device_position(
      ...
      gdk_seat_get_pointer(gdk_display_get_default_seat(gtk_widget_get_display(widget))), &pointerx,
      &pointery, NULL);
#else
  GdkDevice *device
